...
Get detailed info/attributes for a single selected feature by selecting it from dropdown or from layer on map.  

prevent map from zooming too far (which results in error loading the map)
