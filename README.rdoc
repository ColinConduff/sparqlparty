...
Major concern:
	...
	The endpoint or sparql query may be incorrect
	The sparql_queries controller show method may not be setting the headers correctly

Basic input validation for forms 

Get bootstrap and apply to views 
