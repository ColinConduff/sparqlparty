...
Add a dropdown menu to select different operations for the spatial relationship function.

Implement: intersection, union, difference, symDifference, distance, buffer, boundary
...
prevent map from zooming in too far (which results in error loading the map)

Refactor javascript and html code.  Generalize ajax queries.  Use a for loop in index.html.erb to minimize redundant code.  
